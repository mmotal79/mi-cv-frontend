    ...
    <section id="contact" className="py-16 bg-blue-700 text-white">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          <a
            href="mailto:quierohablarteya@gmail.com" // Asegúrate de que este sea tu email real
          ...
          <a
            href="https://www.linkedin.com/in/ing-miguel-mota-ti" // ¡CAMBIA ESTO A TU PERFIL DE LINKEDIN REAL!
            target="_blank"
