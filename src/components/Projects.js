  ...
  const projects = [
    {
      ...
      link: '#', 
      imageUrl: '/assets/proyecto-vehicular.jpg', // <-- CAMBIO: Agregado campo para la imagen (ruta relativa desde la raíz pública)
    },
    {
      ...
      link: '#',
      imageUrl: '/assets/proyecto-bancario.jpg', // <-- CAMBIO: Agregado campo para la imagen
    },
    {
      ...
      link: '#',
      imageUrl: '/assets/proyecto-homebanking.jpg', // <-- CAMBIO: Agregado campo para la imagen
    },
    {
      ...
      link: '#',
      // imageUrl: '/assets/proyecto-auditor.jpg', // <-- EJEMPLO: Este proyecto no tiene imagen para demostrar el caso sin imagen
    },
    {
      ...
      link: '#',
      imageUrl: '/assets/proyecto-software-libre.jpg', // <-- CAMBIO: Agregado campo para la imagen
    },
    {
      ...
      link: '#',
      // imageUrl: '/assets/proyecto-siadca.jpg', // <-- EJEMPLO: Este proyecto no tiene imagen
    },
  ];
