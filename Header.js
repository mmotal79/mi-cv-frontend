    ...
    <header className={`bg-gray-800 text-white p-4 shadow-lg ${isSticky ? 'fixed top-0 left-0 w-full z-50 animate-slide-down' : ''}`}>
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <a href="#ia-agent" onClick={(e) => handleNavLinkClick(e, 'ia-agent')} className="hover:text-blue-400 transition duration-300 font-semibold">
            Agente IA
          </a>
      ...
      {isOpen && (
        <nav className="md:hidden bg-gray-700 mt-4 py-2">
          <ul className="flex flex-col items-center space-y-4">
            ...
            <li>
              <a href="#ia-agent" onClick={(e) => handleNavLinkClick(e, 'ia-agent')} className="block py-2 hover:text-blue-400 transition duration-300 font-semibold">
                Agente IA
              </a>
            </li>
            <li>
